...
- (instancetype)initWithTitles:(NSArray *)titles{
    ...
    return [self initWithTitles:titles withButtonHeight:40 withMenuColor:[UIColor colorWithRed:0 green:0.722 blue:1 alpha:1] withBackBlurStyle:UIBlurEffectStyleDark];
}
// 初始化侧滑栏及按钮样式
...
-(void)drawRect:(CGRect)rect{
    ...
    CGContextSetFillColorWithColor(context, _menuColor.CGColor);
...
- (void)trigger{
    ...
    if (!triggered) {
        ...
        [UIView animateWithDuration:0.7 delay:0.0f usingSpringWithDamping:0.5f initialSpringVelocity:0.9f options:UIViewAnimationOptionBeginFromCurrentState animations:^{
