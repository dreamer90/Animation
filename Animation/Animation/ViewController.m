...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"动画";
    _styleArr = @[@"AnimationCircleController",@"QQCuteViewController",@"GooeySlideMenuController",@"LaunchFlashController",@"FirstViewController",@"JumpStarViewController",@"LoadingBtnViewController"];
